...
public class SmsUtil {
    ...
    public SendSmsResponse sendSms(String phoneNum, String signName, String templateCode, String templateParam) throws ClientException {
